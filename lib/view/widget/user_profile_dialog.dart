...
class UserProfileDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      String statusText = (controller.status.value ?? 0) >= 1 ? 'status_active'.tr : 'status_inactive'.tr;
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  Text(
                    controller.hallname.value.isEmpty ? 'hall_name_label'.tr : controller.hallname.value,
                    style: TextStyle(
                      fontSize: 22,
                  ...
                  Text(
                    controller.name.value.isEmpty ? 'ahmed_alsultan'.tr : controller.name.value,
                    style: TextStyle(
                      fontSize: 15,
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        controller.emailofuser.value.isEmpty ? "owner@luxvenue.com" : controller.emailofuser.value,
