...
class MyTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    "ar": {
      ...
      "account_not_activated_desc": "هذا الحساب لم يتم تفعيله بعد، يرجى التواصل مع الإدارة لتفعيل حسابك.",
      "desktop_access_denied": "وصول غير مصرح به",
      "desktop_access_denied_desc": "لا يمكن استخدام هذا الحساب في سطح المكتب، يمكن استخدامه في تطبيق الهاتف فقط.",
    ...
    "en": {
      ...
      "account_not_activated_desc": "This account is not activated yet. Please contact the administration to activate your account.",
      "desktop_access_denied": "Unauthorized Access",
      "desktop_access_denied_desc": "This account cannot be used on desktop, it can only be used in the mobile app.",
      ...
      "account_not_activated": "Account Not Activated",
      "account_not_activated_desc": "This account is not activated yet. Please contact administration to activate your account.",
      "desktop_access_denied": "Access Denied",
      "desktop_access_denied_desc": "This account cannot be used on desktop. It can only be used on the mobile app.",
      "back_to_login": "Back to Login",
      "name_required": "Name is required",
      "role_added_success": "Role added successfully",
      "role_updated_success": "Role updated successfully",
